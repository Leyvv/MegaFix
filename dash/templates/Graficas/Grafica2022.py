...
query = "SELECT Fecha,GRAN_TOTAL FROM Ventas WHERE YEAR(Fecha) = 2022;"
...
fig = px.bar(df_grouped, x="mes", y="GRAN_TOTAL", 
             title="Ventas por Mes en 2022", barmode="stack")

# 🔹 Guardar gráfico como HTML
fig.write_html("dash/static/graficas/grafica_2022.html")

print("Gráfico guardado como 'grafica_ventas_mensual.html'")
